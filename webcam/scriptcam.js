...
;(function($) {
	$.fn.scriptcam=function(options) {
		...
		return this.each(function() {
			...
			var BASEURL = 'http://192.168.1.226/solitaire/demo/anovate/webcam/';
			
			swfobject.embedSWF(BASEURL+'scriptcam.swf', opts.id, newWidth, newHeight, '11.6', false, opts, params);
