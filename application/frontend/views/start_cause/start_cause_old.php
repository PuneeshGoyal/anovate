    ...
    <form role="form" enctype="multipart/form-data" id="tutorial_replym" action="<?php echo base_url(); ?>start_cause/add_cause" method="post">
      ...
      <div class="row" id="startacause">
        <div class="col-sm-12">
          ...
          <div class="form-group fl">
            ...
            <div class="col-sm-8">
              ...
              <span style="color:#818080;">e.g. -http://www.youtube.com/watch?v=<span style="color:red;">YY5EfaF61hI</span></span> </div>
          </div>
          <div class="form-group fl">
            ...
            <div class="addi_form"> 
              ...
              <div class="form-group col-md-12 col-sm-12 padng_none">
                <div class="form-group col-sm-4 col-xs-12  padng_none2 startacause">
                  <label for="Title" class="control-label">Target amount of pledge<span class="asterisk">*</span></label>
        ...
        <div class="col-md-8 pull-left information_form" id="volunteer_block" style="display:none;">
          <h1>Supporters recruiting additional information</h1>
          <div class="addi_form volunteer_form">
          	<h1>Location<span class="asterisk">*</span></h1>
        ...
        <div class="clearfix"></div>
          ...
          <div class="form-group col-md-12 startacause padng_none_new">
            ...
            <div class="checkbox">
              <label class="label_text">
                ...
                I have confrmed that the information I input is accurate and is of truth and have agreed to the <a href="<?php echo base_url(); ?>pages/terms" target="_blank"> Terms and Conditions </a> for using of this site </label>
            </div>
          </div>
