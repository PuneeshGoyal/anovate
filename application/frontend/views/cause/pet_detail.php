 <div class="container">
  ...
  <div class="input-group checkboxes">
      ...
      <label>Pet adoption :</label>
          <input type="checkbox"/></div><!-- /input-group -->
      </div>
      </div>
  <div class="row ">
  
    <div class="col-md-12 heading m_cseven">
      <h3 class="col-md-2 offset-md-10">Peter the dog</h3>
    </div>
  </div>
  <div class="row custom_row">
    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
      ...
      <div class="discription_inner">
        <p><strong>By:</strong>&nbsp;&nbsp;SPCA</p>
        <p>Tagline: Health, critical illness, low income</p>
       </div>
       <div class="description_icon">
        <ul>
          <li><span class="round_icon">HDB</span></li>
    <li><span class="round_icon">W</span></li>
    <li><span class="round_icon"><img src="<?php echo base_url() ?>images/inj_icon.png"></span></li>
    <li><span class="round_icon">S</span></li>
    </ul>
      </div>
      </div>
      ...
      <div id="container">
        <section class="slider">
          <div id="slider_ab" class="flexslider">
            <ul class="slides">
                  <li><div class="fluid-width-video-wrapper" style="padding-top: 56.2%;"><iframe frameborder="0"  allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" src="http://player.vimeo.com/video/39683393?api=1&amp;player_id=player_1" id="player_1"></iframe></div></li>
                  <li> <img src="<?php echo base_url() ?>images/cause7_slide.jpg" /> </li>
                  <li> <img src="<?php echo base_url() ?>images/cause7_slide.jpg" /> </li>
                  <li> <img src="<?php echo base_url() ?>images/cause7_slide.jpg" /> </li>
                  <li><div class="fluid-width-video-wrapper" style="padding-top: 56.2%;"><iframe frameborder="0"  allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" src="http://player.vimeo.com/video/39683393?api=1&amp;player_id=player_1" id="player_1"></iframe></div></li>
                  <li> <img src="<?php echo base_url() ?>images/cause7_slide.jpg" /> </li>
          ...
          <div id="carousel_ab" class="flexslider">
            <ul class="slides">
               <li> <img src="<?php echo base_url() ?>images/thumbs/cause7_thumb.jpg" /> </li>
               <li> <img src="<?php echo base_url() ?>images/thumbs/cause7_thumb.jpg" /> </li>
             <li> <img src="<?php echo base_url() ?>images/thumbs/cause7_thumb.jpg" /> </li>
               <li> <img src="<?php echo base_url() ?>images/thumbs/cause7_thumb.jpg" /> </li>
             <li> <img src="<?php echo base_url() ?>images/thumbs/cause7_thumb.jpg" /> </li>
      ...
      <div class="row story cause7">
        <p>Mike wishes to become a doctor in the future. However at the age of 20, he was diagnosed with stage 2 colon cancer. His father works as a cleaner while his mother works as a waitress. Their total monthly salary was only $3000 and they have to support Mike high medical expenses and Mike’s younger brother school fees.This cause aimed to raised $5,000 to pay for the preliminary medical expenses .......so on.........Bla Bla Bla </p>
        <p>Mike wishes to become a doctor in the future. However at the age of 20, he was diagnosed with stage 2 colon cancer. His father works as a cleaner while his mother works as a waitress. Their total monthly salary was only $3000 and they have to support Mike high medical expenses and Mike’s younger brother school fees. This cause aimed to raised $5,000 to pay for the preliminary medical expenses .......so on.........Bla Bla Bla</p>
      </div>
    </div>
    ...
    <div class="social_icon">
      <ul>
      <li><a href="#"><img alt="" src="<?php echo base_url() ?>images/icon1.png"></a></li>
      <li><a href="#"><img alt="" src="<?php echo base_url() ?>images/icon2.png"></a></li>
      <li><a href="#"><img alt="" src="<?php echo base_url() ?>images/icon3.png"></a></li>
      <li><a href="#"><img alt="" src="<?php echo base_url() ?>images/icon4.png"></a></li>
      </ul>
      </div>
    <div class="fundraising_main">
    <h1 class="t_upper">Date to be put down:
21/05/2014</h1>
...
Singapore 650241</p>
<div class="donate_bttn"><a href="#">Adopt it now!</a></div>
    </div>
      ...
      <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="col-sm-3 mnt_register_pop">
                    <a href="#"><img src="<?php echo base_url() ?>images/register.png"></a>
                  </div>
      ...
      <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="modal-body">
                        ...
                        <div class="col-sm-12 mnt_row_des">
                            <div class="col-sm-2 col-xs-3 col-sm-offset-1 icon_des"><font><img src="<?php echo base_url() ?>images/injection.png"></font></div>
                            <div class="col-sm-9 col-xs-9">
            ...
            <div class="modal-content">
                  ...
                  <div class="form-group mnt_sm_offset-1 mnt_form_style mnt_share_cause">
                    ...
                    <div class="col-sm-9 mnt-modal7">
                        <label class="checkbox-inline mnt_f"><input type="checkbox" id="inlineCheckbox1" value="option1"><img src="<?php echo base_url() ?>images/f.png"></label>  
                        <label class="checkbox-inline mnt_t"><input type="checkbox" id="inlineCheckbox2" value="option2"><img src="<?php echo base_url() ?>images/t.png"></label> 
                        <label class="checkbox-inline mnt_g"><input type="checkbox" id="inlineCheckbox3" value="option3"><img src="<?php echo base_url() ?>images/g.png"></label>
                    </div> 
                  </div>   
            ...
            <div class="modal-content">
                  ...
                  <div class="form-group mnt_sm_offset-1 mnt_form_style mnt_share_cause">
                    ...
                    <div class="col-sm-7 mnt-modal7">
                        <label class="checkbox-inline mnt_f"><input type="checkbox" value="option1" id="inlineCheckbox1"><img src="<?php echo base_url() ?>images/f.png"></label>  
                        <label class="checkbox-inline mnt_t"><input type="checkbox" value="option2" id="inlineCheckbox2"><img src="<?php echo base_url() ?>images/t.png"></label> 
                        <label class="checkbox-inline mnt_g"><input type="checkbox" value="option3" id="inlineCheckbox3"><img src="<?php echo base_url() ?>images/g.png"></label>
                    </div> 
                  </div>
                      ...
                      <div class="modal-body">                  
                        <div class="mnt_table_popup mnt_mb4">
                            ...
                            <div class="col-sm-4 col-xs-6 mnt_row_des">
                                    <span class="icon_des"><img src="<?php echo base_url() ?>images/icon_des-1.png"></span>
                                    <span class="icon_des"><img src="<?php echo base_url() ?>images/icon_des-2.png"></span>
                                    <span class="icon_des"><img src="<?php echo base_url() ?>images/icon_des-3.png"></span>
                            </div>
