    ...
    <div id="content">
      <ul id="tabs" class="nav nav-tabs acc_custom_nav_tabs" data-tabs="tabs">
       <!-- <li class="active"><a href="#Particulars" data-toggle="tab">Particulars</a></li>
		...
		<li class="active"><a href="<?php echo base_url();?>accounts/particulars">Particulars</a></li>
        <li><a href="<?php echo base_url();?>accounts/manage_cause">Manage Your Causes</a></li>
