...
function showDay($dy,$dm,$da,$caption="") { 
	...
	if(in_array($time1,$dates)){ $class = "cell vik partial-booked week_delete"; }else { $class= "cell vik ".$disabled_days.""; }
	}
	...
	/*else if(in_array($selected_dat, $selectedDate) && getCalviewType($selected_dat) != "month"){
		...
		if(in_array($time2,$dates)){ $class = " cell vik partial-booked week_delete"; }else { $class= "cell vik ".$disabled_days.""; }
	}
	...
	while ($i < $max) {
		...
		if(time() > $time){$disabled_days = 'disabled_days'; $full='';}else{$disabled_days=''; $full='booked';}
		if(in_array($selected_dat, $selectedDate) && getCalviewType($selected_dat) == "month"){
			$class = "cell  ".$full." ".$disabled_days.""; 
		}
		/*else if(in_array($selected_dat, $selectedDate) && getCalviewType($selected_dat) != "month"){
			...
			if(in_array($time,$dates)){ $class = "cell vik partial-booked week_delete"; }else { $class= "cell vik ".$disabled_days.""; }
		}
