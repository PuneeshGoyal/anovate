...
<div class="col-md-12"> 
  ...
  <ul class="page-breadcrumb breadcrumb">
    ...
    <li> <a href="javascript:void(0);"> Content Mangement / Donations  </a> </li>
  </ul>
        ...
        <div class="row">
          <div class="col-md-9" style="width:100%">
            ...
            <div class="form-group">
              ...
              <a href="<?php echo base_url();?>content/donations"  class="btn theme-btn grey pull-left margd">Cancel</a>
              </div>
            </div>
            </form>
          </div>
