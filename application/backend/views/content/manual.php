...
<div class="col-md-12"> 
  ...
  <ul class="page-breadcrumb breadcrumb">
    ...
    <li> <a href="javascript:void(0);"> Content / Manual  </a> </li>
  </ul>
...
<div class="col-md-12"> 
  ...
  <div class="tabbable tabbable-custom tabbable-full-width">
    <ul class="nav nav-tabs">
      <li class="active"> <a href="#tab_1_1" data-toggle="tab">  Manual </a> </li>
    </ul>
        ...
        <div class="row">
          <div class="col-md-9" style="width:100%">
            ...
            <div class="form-group">
              ...
              <a href="<?php echo base_url();?>content/manual"  class="btn theme-btn grey pull-left margd">Cancel</a>
              </div>
            </div>
            </form>
          </div>
