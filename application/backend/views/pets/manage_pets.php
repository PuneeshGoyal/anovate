...
<div class="row">
  <div class="col-md-12"> 
    ...
    <ul class="page-breadcrumb breadcrumb">
      ...
      <li> <a href="javascript:void(0);"> Manage Pet Listing </a> </li>
    </ul>
  ...
  <div class="col-md-12">
    <div class="tabbable tabbable-custom tabbable-full-width">
      <ul class="nav nav-tabs">
        <li class="active"> <a data-toggle="tab" href="#tab_1_5"> Manage Pet Listing </a> </li>
      </ul>
              ...
              <tbody>
				...
				<tr>
				  ...
				  <td> <span data-time="<?php echo !empty($closetime) ? $closetime : "";?>" class="kkcount-down timer"></span></td>
				   <td><?php echo $this->common->get_user_name($val['userid'],$val['user_type']);?></td>
				   <td><?php echo $type;?></td>
                 ...
                 <a data-toggle="modal"  href='<?php echo  base_url().$this->router->class.'/view_appointment/'.$val['slug']?>' data-target="#view_appointment_modal"> 
                  <i class="fa fa-search fonta"></i>
                  </a>
                  </span>
                  ...
                  <!--<?php if($val['featured'] == '1'){?>
                    ...
                    <?php } ?></td>-->
                     ...
                     <td>
                     <a class="javascript:void(0)" href="<?php echo base_url().$this->router->class; ?>/view_pet/<?php echo $val['id'];?>"> <i class="fa fa-search fonta"></i> </a> 
                     <a class="javascript:void(0)" href="<?php echo base_url().$this->router->class; ?>/archive_pets/<?php echo $val['id'];?>" onclick="return archive_tag();">
