...
<div class="col-md-12"> 
  ...
  <ul class="page-breadcrumb breadcrumb">
    ...
    <li> <a href="javascript:void(0);"> Content Mangement / How it works  </a> </li>
  </ul>
...
<div class="col-md-12"> 
  ...
  <div class="tabbable tabbable-custom tabbable-full-width">
    <ul class="nav nav-tabs">
      <li class="active"> <a href="#tab_1_1" data-toggle="tab">  Donations </a> </li>
    </ul>
        ...
        <div class="row">
          <div class="col-md-9" style="width:100%">
            ...
            <div class="tab-pane active" id="tab1"> </div>
             ...
             <form name="frm" id="frm" action="<?php echo base_url(); ?><?php echo $this->router->class;?>/update_aboutus_to_database" method="post" enctype="multipart/form-data">
              <?php if($do=="edit"){ ?>
