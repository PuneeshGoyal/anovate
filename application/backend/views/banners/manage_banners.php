              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php if($val['status'] == '1'){ ?>
                    <span class="label label-sm label-success"> <a href="<?php echo base_url().$this->router->class;?>/enable_disable_banners/<?php echo $val['id'];?>/0" onclick="return dis_fun('<?php echo $item?>');">Inactive</a> </span>
                    <?php }else{ ?>
                    <span class="label label-sm label-success"> <a href="<?php echo base_url().$this->router->class;?>/enable_disable_banners/<?php echo $val['id'];?>/1" onclick="return enb_fun('<?php echo $item?>');">Active</a> </span>
                    <?php } ?></td>
                  <td><!--<a class="javascript:void(0)" href="<?php echo base_url().$this->
                    router->class; ?>/view_cause/<?php echo $val['id'];?>"> <i class="fa fa-search fonta"></i> </a>--> <a class="javascript:void(0)" href="<?php echo base_url().$this->router->class;?>/delete_banners/<?php echo $val['id'];?>" onclick="return archive_fun('<?php echo $item?>');"><i class="fa fa-times fonta"></i></a> <a class="javascript:void(0)" href="<?php echo base_url().$this->router->class; ?>/edit_banners/<?php echo $val['id'];?>"><i class="fa fa-edit fonta"></i></a></td>
                </tr>
                <?php }}else{?>
                <tr class="scndrow">
