  ...
  <div class="col-md-12"> 
    ...
    <div class="tabbable tabbable-custom tabbable-full-width">
      <ul class="nav nav-tabs">
        <li class="active"> <a href="#tab_1_1" data-toggle="tab"> Add Breed </a> </li>
      </ul>
        ...
        <div class="tab-pane active" id="tab_1_1">
          <div class="row">
            <div class="col-md-9">
              ...
              <form name="frm" id="frm" action="<?php echo base_url().$this->router->class;?>/add_breed_to_database" method="post">
              
              <?php if($do=="edit"){?>
                  <input type="hidden" name="id" value="<?php echo !empty($breeddata['id']) ? $breeddata['id'] : "";?>">
              <?php	}?>
              ...
              <div class="form-group flare">
                ...
                <div class="col-md-8">
                  <input class="form-control"  name="name" id="name" type="text" value="<?php echo !empty($breeddata['name']) ? $breeddata['name'] : "";?>"/>
                </div>
              </div>
			  ...
			  <div class="form-group">
                ...
                <div class="col-md-8">
                   <input type="submit" value="Save" class="btn theme-btn green pull-left" >
                          <a href="<?php echo base_url().$this->router->class;?>/manage_breed"  class="btn theme-btn grey pull-left margd">Cancel</a>
                </div>
              </div>
              </div>
              </form>
